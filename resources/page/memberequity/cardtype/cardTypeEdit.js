...
define(function( require ){
    ...
    ngAMD.controller( "cardTypeEdit",["$scope","$rootScope","ajaxService",'register','shopSelectorService','$uibModal','modalService',function( $scope,$rootScope,ajaxService, register,shopSelectorService,$uibModal,modalService ){
