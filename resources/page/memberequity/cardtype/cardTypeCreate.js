...
define(function( require ){
    ...
    ngAMD.controller( "cardTypeCreate",["$scope","$rootScope","ajaxService",'register','shopSelectorService','$uibModal','modalService',function( $scope,$rootScope,ajaxService,register,shopSelectorService,$uibModal,modalService ){
