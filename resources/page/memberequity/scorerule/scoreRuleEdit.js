define(['ngAMD','shopSelector'],function(ngAMD){

	ngAMD.controller( "scoreRuleEdit",["$scope","$rootScope","ajaxService",'register','shopSelectorService','modalService',function( $scope,$rootScope,ajaxService, register,shopSelectorService,modalService ){
