  ...
  */       	
        	...
        	return {
                init: function () {
            		...
            		//初始化连接设备管理器配置
            		var cfg = {
            			location:"ws://127.0.0.1:5414", //websocket链接管理器地址，相对本机，而不是服务器。
            			initCallBack:function(){
            				//发送给设备管理器contenxPath ,更改ini，设备管理器调用项目接口地址
            				me.rpt.init("http://192.168.12.132:7001/cy7/");
            				//加载打印机列表
            				me.rpt.printerlist(function(result){
        						...
        						console.log($rootScope.printers);
            				});
            			},
            		};
            		//传入cfg
     ...
     */
                printhyz:function(){
                	...
                	TDevices.report.design(printinfo);
                },   
                /**
                 * 打印
                 */
	                print:function(printData){
	                   TDevices.report.print(printData)
	                }, 
	            /**
	             * 设计
	             */
	                design:function(printData){
		               TDevices.report.design(printData);
	                },
               /**
                * 导出
                */
	                exportData:function(printData){
	                   TDevices.report.exportdata(printData)
	                },
                /**
                 * 预览
                 */
	                preview:function(printData){
 	                   TDevices.report.preview(printData)
 	                }
            }
        }]);
});
