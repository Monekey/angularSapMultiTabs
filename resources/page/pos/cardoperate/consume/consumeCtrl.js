			...
			function($scope, $window, ajaxService, posService,
	            ...
	            $scope.doConsume = function(){
	            	...
	            	console.log($scope.consumeVo.allMoney);
	            		modalService.info({content:'实付总金额与账单金额不匹配!', type: 'ok'});
	            		return false;
	            	}
	            	if(!$scope.flg.isSave){
	            		return false;
