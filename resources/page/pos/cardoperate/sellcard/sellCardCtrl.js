...
define(function (require) {
    ...
    return[
            ...
            '$rootScope',
			'$timeout',
            function ($scope,$uibModal,posService,ajaxService, register, getCookieService, appConstant,modalService, $rootScope, $timeout) {
                ...
                $scope.getSellCardSmsCode = function(sellCardType){
                	...
                	if(cardSellObj.cardInfo.mobile && cardSellObj.cardInfo.mobile != ''
                		&& /^(13[0-9]|15[012356789]|17[678]|18[0-9]|14[57])[0-9]{8}$/.test(cardSellObj.cardInfo.mobile)){
                		//调用获取短信
                		ajaxService.AjaxPost({mobile: cardSellObj.cardInfo.mobile, sessionId: sessionId}, 'common/sms/getSmsCode.do').then(function (result) {
                            if(result.status){
