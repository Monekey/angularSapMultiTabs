...
define(function( require ){
    ...
    ngAMD.controller( "recipientSelectorCtrl",["$scope","ajaxService","getCookieService", "noticeEmps", "$uibModalInstance", function($scope,ajax,cookie,noticeEmps,$uibModalInstance){
