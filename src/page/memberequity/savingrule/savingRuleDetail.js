define(function (require) {
	...
	var app = require("app");
	app.ngAMDCtrlRegister.controller("savingRuleDetail", ["$scope", "$rootScope", "ajaxService", "getCookieService", 'register', function ($scope, $rootScope, ajaxService, getCookieService, register) {
