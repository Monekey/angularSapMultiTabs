...
define(function( require ){
    ...
    app.ngAMDCtrlRegister.controller( "savingSelectorCtrl",["$scope","ajaxService","getCookieService", "ruleIds", "$uibModalInstance", function($scope,ajax,cookie,ruleIds,$uibModalInstance){
       ...
       //获取sessionId
        ...
        $scope.pageChanged = function () {
        	 $scope.pageSetInit();
        	 ajax.AjaxPost($scope.pageSet, "memberequity/cardtype/selectSavingRules.do" ).then(function( result ){
