...
define(function( require ){
    ...
    app.ngAMDCtrlRegister.controller( "exchangeSelectorCtrl",["$scope","ajaxService","getCookieService", "ruleIds", "$uibModalInstance", function($scope,ajax,cookie,ruleIds,$uibModalInstance){
