define(function (require) {
	...
	var app = require("app");
	app.ngAMDCtrlRegister.controller("exchangeRuleDetail", ["$scope", "$rootScope", "ajaxService", "getCookieService", 'register', function ($scope, $rootScope, ajaxService, getCookieService, register) {
