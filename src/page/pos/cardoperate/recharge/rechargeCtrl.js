...
define(['posService'], function () {
    ...
    return ["$scope",'$window',"ajaxService","posService","getCookieService","$rootScope","modalService","$filter",
            function ($scope,$window,ajaxService,posService,getCookieService,$rootScope,modalService,$filter) {
    		//sessionId获取
