...
define(['angular', 'posService'], function (angular) {
    ...
    return ["$scope", "ajaxService", "getCookieService", "$rootScope", "modalService", '$state', 'posService','$timeout',
        function ($scope, ajaxService, getCookieService, $rootScope, modalService, $state, posService, $timeout) {
