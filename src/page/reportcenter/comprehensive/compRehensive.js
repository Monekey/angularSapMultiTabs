            ...
            function ($scope,
                ...
                $scope.openSelectParam = function(){
                    ...
                    var modalInstance = $uibModal.open({
                        animation: true,
                        templateUrl: 'src/page/reportcenter/comprehensive/selectParam.html',
                        controller: ['$scope','$rootScope','$uibModalInstance','$state',"ajaxService","getCookieService",
                         ...
                         $scope.closeTab=function(){
                        	...
                        	$scope.oo=function(){
                      		    flag=1;
                        		var all_money_sum= document.getElementById("all_money_sum").checked;
                        		var member_money_sum= document.getElementById("member_money_sum").checked;
                        		var money_out_sum= document.getElementById("money_out_sum").checked;
                        		var givemoney_out_sum= document.getElementById("givemoney_out_sum").checked;
                        		var all_money_count= document.getElementById("all_money_count").checked;
                        		var member_money_count= document.getElementById("member_money_count").checked;
                        		var money_in_count= document.getElementById("money_in_count").checked;
                        		var money_in_sum= document.getElementById("money_in_sum").checked;
                        		var givemoney_in_sum= document.getElementById("givemoney_in_sum").checked;
                        		var integration_in_count= document.getElementById("integration_in_count").checked;
                        		var integration_in_sum= document.getElementById("integration_in_sum").checked;
                        		var integration_out_count= document.getElementById("integration_out_count").checked;
                        		var integration_out_sum= document.getElementById("integration_out_sum").checked;
                        		var buy_card_count= document.getElementById("buy_card_count").checked;
                        		var buy_card_sum= document.getElementById("buy_card_sum").checked;
                        		var cancel_card_count= document.getElementById("cancel_card_count").checked;
                        		var cancel_card_sum= document.getElementById("cancel_card_sum").checked;
                        		var change_crad_type_count= document.getElementById("change_crad_type_count").checked;
                        		var update_card_count= document.getElementById("update_card_count").checked;
                        		var change_crad_date_count= document.getElementById("change_crad_date_count").checked;                      		
                        		var v1 = document.getElementById("v1").checked;
                        		var v2 = document.getElementById("v2").checked;
